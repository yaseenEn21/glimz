...
return [
    ...
    'coupons' => [
        ...
        'visible_in_app_label' => 'يظهر في قائمة الكوبونات',
        'visible_in_app_hint' => 'عند التفعيل، سيظهر الكوبون للعملاء في قائمة الكوبونات داخل التطبيق',
        'internal_notes' => 'ملاحظات داخلية',
        'notes_placeholder' => 'ملاحظات خاصة بالفريق (لا تظهر للعميل)...',
        'notes_hint' => 'هذه الملاحظات للاستخدام الداخلي فقط ولن تظهر للعملاء',
        ...
        'fields' => [
            ...
            'period' => 'الفترة',
            'limits' => 'الحدود',
            'is_visible_in_app' => 'الظهور في التطبيق',
        ],
