...
@section('title', __('bookings.cancel_reasons.edit'))
...
<div class="card">
    <form id="cancel_reason_form" action="{{ route('dashboard.bookings.cancel-reasons.update', $reason['id']) }}" method="POST">
        @method('PUT')
        <div class="card-body">
            @include('dashboard.bookings.cancel_reasons._form', compact('reason'))
        </div>
