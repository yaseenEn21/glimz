...
<form action="{{ route('dashboard.faqs.store') }}" method="POST">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('faqs.create') }}</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="mb-5">
                ...
                <textarea name="answer_ar" rows="4" class="form-control @error('answer_ar') is-invalid @enderror">{{ old('answer_ar') }}</textarea>
                @error('answer_ar')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-5">
                ...
                <textarea name="answer_en" rows="4" class="form-control @error('answer_en') is-invalid @enderror">{{ old('answer_en') }}</textarea>
                @error('answer_en')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
