...
<form id="employee_create_form" action="{{ route('dashboard.employees.store') }}" method="POST">
    ...
    <div class="card mt-6">
        ...
        <div class="card-body pt-0">
            ...
            <div class="mb-3">
                <input class="form-control" name="area_name" id="area_name" value="{{ old('area_name') }}"
            ...
            <div class="modal-body pt-4">
                ...
                <div class="fv-row">
                    ...
                    <select id="import_schedule_employee" class="form-select" data-control="select2"
                        ...
                        <option></option>
                        @foreach (\App\Models\Employee::with('user')->whereHas('user', fn($q) => $q->where('is_active', true)->where('user_type', 'biker'))->get() as $emp)
                            <option value="{{ $emp->id }}"
...
<script>
    ...
    (function() {
        ...
        /**
         * تعبئة حقول جدول العمل الأسبوعي بالبيانات المستوردة
         * @param {Object} schedule - { saturday: { work: {...}, break: {...} }, ... }
         */
