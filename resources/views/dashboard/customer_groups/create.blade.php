...
<div class="card">
    <form id="group_form" action="{{ route('dashboard.customer-groups.store') }}" method="POST">
        @csrf
                    ...
                    <div class="card mb-7">
                        ...
                        <div class="card-body pt-0">
                            <div class="fv-row">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="{{ __('customer_groups.placeholders.name') }}">
        ...
        $.ajax({
            ...
            success: function(res) {
                Swal.fire({
                    ...
                    text: res.message || "{{ __('customer_groups.created_successfully') }}",
                    timer: 2000,
