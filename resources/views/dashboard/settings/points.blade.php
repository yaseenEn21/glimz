            ...
            <div class="row g-6">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number"
                           ...
                           name="redeem_points"
                           value="{{ old('redeem_points', $data['redeem_points']) }}"
                           min="1">
                    <div class="form-text">{{ __('points_settings.redeem_points.hint') }}</div>
                    @error('redeem_points') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number"
                           ...
                           name="redeem_amount"
                           value="{{ old('redeem_amount', $data['redeem_amount']) }}"
                           min="0.01">
                    <div class="form-text">{{ __('points_settings.redeem_amount.hint') }}</div>
                    @error('redeem_amount') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number"
                           ...
                           value="{{ old('min_redeem_points', $data['min_redeem_points']) }}"
                           min="1">
                    <div class="form-text">{{ __('points_settings.min_redeem_points.hint') }}</div>
                    @error('min_redeem_points') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
