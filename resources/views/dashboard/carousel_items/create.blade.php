...
<div class="card">
    <form id="carousel_form" action="{{ route('dashboard.carousel-items.store') }}" method="POST"
                    ...
                    <div class="row g-9">
                        ...
                        <div class="col-12">
                            <select name="display_type" class="form-select">
                                <option value="slider" selected>{{ __('carousel.display_types.slider') }}</option>
                                <option value="popup">{{ __('carousel.display_types.popup') }}</option>
                                <option value="both">{{ __('carousel.display_types.both') }}</option>
                            </select>
                        </div>
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <textarea name="description[ar]" class="form-control" rows="4"
                                            placeholder="{{ __('carousel.placeholders.description') }}"></textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <select id="carouselable_key" name="carouselable_key" class="form-select"
                                            ...
                                            @foreach ($carouselableKeys as $k)
                                                <option value="{{ $k }}">{{ __('carousel.types.' . $k) }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback"></div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    Swal.fire({
                        ...
                        text: res.message ||
                            "{{ __('carousel.created_successfully') }}",
                        timer: 1500,
