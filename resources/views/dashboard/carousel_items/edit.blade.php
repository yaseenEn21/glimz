...
<div class="card">
    <form id="carousel_form" action="{{ route('dashboard.carousel-items.update', $carouselItem->id) }}" method="POST"
            ...
            <ul class="nav nav-tabs nav-line-tabs mb-6">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab"
                        href="#tab_content">{{ __('carousel.tabs.content') }}</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="row g-9">
                        <div class="col-12">
                            <select name="display_type" class="form-select">
                                <option value="slider" @selected(old('display_type', $carouselItem->display_type) === 'slider')>
                                    {{ __('carousel.display_types.slider') }}
                                </option>
                                <option value="popup" @selected(old('display_type', $carouselItem->display_type) === 'popup')>
                                    {{ __('carousel.display_types.popup') }}
                                </option>
                                <option value="both" @selected(old('display_type', $carouselItem->display_type) === 'both')>
                                    {{ __('carousel.display_types.both') }}
                                </option>
                            </select>
                        </div>
                        <div class="col-lg-6">
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    <div class="fv-row mb-5">
                                        ...
                                        <input name="label[ar]" class="form-control"
                                    ...
                                    <div class="fv-row mb-5">
                                        <label
                                            class="required fw-semibold mb-2">{{ __('carousel.fields.title') }}</label>
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <textarea name="description[ar]" class="form-control" rows="4"
                                            placeholder="{{ __('carousel.placeholders.description') }}">{{ old('description.ar', data_get($carouselItem->description, 'ar', '')) }}</textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>

                                    <div class="fv-row mb-4">
                                        <label class="fw-semibold mb-2">{{ __('carousel.fields.hint') }}</label>
                                        <input name="hint[ar]" class="form-control"
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <input name="cta[ar]" class="form-control"
                        ...
                        <div class="col-lg-6">
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    <div class="fv-row mb-5">
                                        <label class="fw-semibold mb-2">{{ __('carousel.fields.label') }}</label>
                                        <input name="label[en]" class="form-control"
                                            placeholder="{{ __('carousel.placeholders.label') }}"
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <textarea name="description[en]" class="form-control" rows="4"
                                            placeholder="{{ __('carousel.placeholders.description') }}">{{ old('description.en', data_get($carouselItem->description, 'en', '')) }}</textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>

                                    <div class="fv-row mb-4">
                                        <label class="fw-semibold mb-2">{{ __('carousel.fields.hint') }}</label>
                                        <input name="hint[en]" class="form-control"
                                            placeholder="{{ __('carousel.placeholders.hint') }}"
                                    ...
                                    <div class="fv-row">
                                        <label class="fw-semibold mb-2">{{ __('carousel.fields.cta') }}</label>
                                        <input name="cta[en]" class="form-control"
                                            placeholder="{{ __('carousel.placeholders.cta') }}"
                    ...
                    <div class="row g-9">
                        <div class="col-lg-6">
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    @php
                                        $imageArUrl = method_exists($carouselItem, 'getFirstMediaUrl')
                                            ? $carouselItem->getFirstMediaUrl('image_ar')
                                            : null;
                                    @endphp
                                    ...
                                    @if (!empty($imageArUrl))
                                        <div class="mb-4">
                                            <div class="d-flex align-items-center gap-3">
                                                <img src="{{ $imageArUrl }}" alt="image_ar" class="rounded border"
                        ...
                        <div class="col-lg-6">
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    @php
                                        $imageEnUrl = method_exists($carouselItem, 'getFirstMediaUrl')
                                            ? $carouselItem->getFirstMediaUrl('image_en')
                                            : null;
                                    @endphp
                                    ...
                                    @if (!empty($imageEnUrl))
                                        <div class="mb-4">
                                            <div class="d-flex align-items-center gap-3">
                                                <img src="{{ $imageEnUrl }}" alt="image_en" class="rounded border"
                                                    style="width: 120px; height: 120px; object-fit: cover;">
                                                <div class="text-muted small">
                                                    {{ __('carousel.current_image') ?? 'Current image' }}
                                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="fv-row mb-5">
                                        <label
                                            class="fw-semibold mb-2">{{ __('carousel.fields.carouselable_type') }}</label>
                                        <select id="carouselable_key" name="carouselable_key" class="form-select"
                                            data-placeholder="{{ __('carousel.placeholders.carouselable_type') }}">
                                            <option></option>
                                            @foreach ($carouselableKeys as $k)
                                                <option value="{{ $k }}" @selected(old('carouselable_key', $carouselItem->carouselable_key) == $k)>
                                                    {{ __('carousel.types.' . $k) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    @php
                                        ...
                                        $selectedText =
                                            $carouselableSelectedText ?? ($selectedId ? '#' . $selectedId : '');
                                    @endphp

                                    <div class="fv-row">
                                        <label
                                            class="fw-semibold mb-2">{{ __('carousel.fields.carouselable_id') }}</label>
                                        <select id="carouselable_id" name="carouselable_id" class="form-select"
                                            data-placeholder="{{ __('carousel.placeholders.carouselable_item') }}"
                                            data-selected-id="{{ $selectedId }}"
                                            data-selected-text="{{ $selectedText }}" @disabled(empty($selectedKey))>
                                            <option></option>
                                        </select>
                                        <div class="invalid-feedback"></div>
                                    </div>
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row g-6">
                                        <div class="col-md-6">
                                            <label
                                                class="fw-semibold mb-2">{{ __('carousel.fields.sort_order') }}</label>
                                        ...
                                        <div class="col-md-6">
                                            <label
                                                class="fw-semibold mb-2 d-block">{{ __('carousel.fields.status') }}</label>
                                            ...
                                            <div
                                                ...
                                                <input class="form-check-input" type="checkbox" name="is_active"
                                                    value="1" @checked((int) old('is_active', (int) ($carouselItem->is_active ?? 0)) === 1)>
                                                <label
                                                    class="form-check-label fw-semibold">{{ __('carousel.active') }}</label>
                                            </div>
                                            <div class="invalid-feedback d-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-6 mt-2">
                                        <div class="col-md-6">
                                            <label
                                                class="fw-semibold mb-2">{{ __('carousel.fields.starts_at') }}</label>
                                            <input type="datetime-local" name="starts_at" class="form-control"
                                                value="{{ old('starts_at', $carouselItem->starts_at?->format('Y-m-d\TH:i')) }}">
                                            <div class="invalid-feedback"></div>
                                            <div class="form-text">{{ __('carousel.starts_at_hint') }}</div>
                                        </div>

                                        <div class="col-md-6">
                                            <label
                                                class="fw-semibold mb-2">{{ __('carousel.fields.ends_at') }}</label>
                                            <input type="datetime-local" name="ends_at" class="form-control"
                                                value="{{ old('ends_at', $carouselItem->ends_at?->format('Y-m-d\TH:i')) }}">
                                            <div class="invalid-feedback"></div>
                                            <div class="form-text">{{ __('carousel.ends_at_hint') }}</div>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    Swal.fire({
                        ...
                        text: res.message ||
                            "{{ __('carousel.updated_successfully') ?? __('carousel.created_successfully') }}",
                        timer: 1500,
                ...
                error: function(xhr) {
                    if (xhr.status === 422 && xhr.responseJSON?.errors) {
                        if (window.KH && typeof window.KH.showValidationErrors === 'function') {
                            ...
                            $('#form_result').removeClass('d-none').addClass('alert-danger')
