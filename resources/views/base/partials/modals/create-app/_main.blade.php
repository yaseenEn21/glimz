...
@include('base.partials.modals/create-app/steps/_step-1')
@include('base.partials.modals/create-app/steps/_step-2')
@include('base.partials.modals/create-app/steps/_step-3')
@include('base.partials.modals/create-app/steps/_step-4')
@include('base.partials.modals/create-app/steps/_step-5')
                            <!--begin::Actions-->
