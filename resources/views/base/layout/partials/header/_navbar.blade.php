...
<div class="app-navbar flex-shrink-0">
    <!--begin::Search-->
    <div class="app-navbar-item align-items-stretch ms-1 ms-md-4 d-none">
        @include('base.partials.search/_dropdown')
    </div>
    <!--end::Search-->
    <!--begin::Activities-->
    ...
    <!--end::Activities-->
    <!--begin::Notifications-->
    <div class="app-navbar-item ms-1 ms-md-4" id="notification-icon">
        <!--begin::Menu- wrapper-->
        <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px"
        ...
        @include('base.partials.menus/_notifications-menu')
        <!--end::Menu wrapper-->
    </div>
    <!--end::Notifications-->
    <!--begin::Chat-->
    ...
    <div class="app-navbar-item ms-1 ms-md-4 d-none">
        ...
        @include('base.partials.menus/_my-apps-menu')
        <!--end::Menu wrapper-->
    </div>
    <!--end::My apps links-->
    <!--begin::Theme mode-->
    <div class="app-navbar-item ms-1 ms-md-4">
        @include('base.partials.theme-mode/_main')
    </div>
    <!--end::Theme mode-->
    <!--begin::User menu-->
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            ...
            <img alt="user" class="rounded-3" src="{{ auth()->user()->getFirstMediaUrl('profile_image') ?: asset('assets/media/avatars/blank.png') }}"/>
        </div>
        @include('base.partials.menus/_user-account-menu')
        <!--end::Menu wrapper-->
    </div>
    <!--end::User menu-->
