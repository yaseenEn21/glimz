...
<head>
    ...
    @if (app()->getLocale() === 'ar')
        ...
        <style>
            ...
            /* تمركز رسالة "جار المعالجة..." في منتصف الجدول */
            #kt_datatable_zero_configuration_wrapper .dataTables_processing {
                position: absolute;
                top: 50%;
                left: 50%;
                /* مناسب لـ RTL و LTR */
            ...
            */
            ...
            /* 1) تمركز رسالة "جارِ المعالجة..." لأي جدول DataTables */
            .dataTables_wrapper {
                position: relative;
                /* مرجِع للتموضع */
            }
            ...
            .main-attachment-thumb,
            .ins-attachment-thumb {
                height: 240px;
                border-radius: .75rem;
                overflow: hidden;
                background: #f9fafb;
            ...
            .main-attachment-thumb img,
            .ins-attachment-thumb img {
                width: 100%;
                height: 100%;
                object-fit: cover;
                display: block;
