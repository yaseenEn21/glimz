...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $this->call([
            ...
            ServiceSeeder::class,
            // ImportRekazServicesSeeder::class,
            ServiceGroupPriceSeeder::class,
            ServiceZonePriceSeeder::class,
            PackageSeeder::class,
            // ImportRekazPackagesSeeder::class,
            ...
            // ImportRekazProductsSeeder::class,
            EmployeeTestSeeder::class,
            // ImportRekazEmployeesSeeder::class,
            ...
            // ImportRekazBranchesSeeder::class,
            ExternalPaymentMethodSeeder::class,
            MismarPartnerSeeder::class,
        ]);
    }
}
